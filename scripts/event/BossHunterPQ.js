...
function playerEntry(eim, player) {
	...
	player.getClient().getSession().write(tools.MaplePacketCreator.serverNotice(6, "Omega Sector is under attack. Protect it!!"));
	player.getClient().getSession().write(tools.MaplePacketCreator.musicChange("Bgm14/DragonNest"));
	//THE CLOCK IS SHIT
