    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getPlayer().getLevel() >= minLevel) {
                if (cm.getQuestStatus(32200) != Packages.client.MapleQuestStatus.Status.COMPLETED
                    && cm.getQuestStatus(32200) != Packages.client.MapleQuestStatus.Status.STARTED) {
                    cm.startQuest(32200);
                ...
                else if (cm.getQuestStatus(32201) == Packages.client.MapleQuestStatus.Status.STARTED) {
                ...
                if (cm.getQuestStatus(32201) == Packages.client.MapleQuestStatus.Status.COMPLETED) {
