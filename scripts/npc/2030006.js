...
var qChars = new Array ("Q1: What EXP is needed to level up from Level 1 to Level 2?#10#12#15#20#3",
	...
	"Q1: At 1st Job Advancement, which job is based in Henesys?#Warrior#Bowman#Magician#Thief#2");
...
var qQuests = new Array("Q4: Which Quest requires you to kill 50 Stumps?#Stump Horror Story#Pio's Collecting#Johns Flower Basket#Jane the Alchemist#1",
	...
	"Q4: Which quest requires you to collect eggs?#Mason the Collector#Nemi#Alcaster#Arwin#2",
	"Q4: Which 2nd job uses throwing stars and a claw?#Bandit#Assassin#Hunter#Cleric#2",
	"Q4: What color is a LUK Crystal?#Pink#Red#Purple#Green#1");
var qTowns = new Array( "Q5: Which town has 'Grendel the really old'?#Henesys#Perion#Kerning City#Ellinia#4",
	...
	"Q5: Which town has the 'Toy Factory'?#Mu Lung#Herb Town#Leafre#Ludibrium#4",
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            if (cm.haveItem(4031058) || !cm.getQuestStatus(32102).equals(MapleQuestStatus.Status.STARTED)) {
//                if (cm.haveItem(4031058)) {
//                    cm.sendOk("#h #, you have the #t4031058# already. Please don't waste my time.");
//                    cm.dispose();
//                }
//                if (!cm.getQuestStatus(32102).equals(MapleQuestStatus.Status.STARTED)) {
//                    cm.sendOk("#h #, you have not started the quest yet!")
//                    cm.dispose();
//                }
                cm.sendOk("Hey! Stop that!");
                cm.dispose();
            } else {
